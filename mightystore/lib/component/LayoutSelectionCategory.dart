                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Container(
                        ...
                        child: Container(
                            ...
                            child: IconButton(
                                icon: Image.asset(select[index].image, height: 24, width: 24, color: select[index].isSelected ? Colors.black : Colors.white),
                                onPressed: () async {
                                  init();
                                  ...
                                  if (index == 0)
                                    ...
                                    crossvalue = 2;
                                  setValue(CATEGORY_CROSS_AXIS_COUNT, crossvalue);
