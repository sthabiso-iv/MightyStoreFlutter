...
class ChooseDemoState extends State<ChooseDemo> {
              ...
              onPressed: () async {
                ...
                setState(() {
                  if (primaryColor != null) {
                    primaryColor = getColorFromHex(mPrimaryColor, defaultColor: Color(0xFF4358DD));
                  } else {
        ...
        body: StaggeredGridView.countBuilder(
          ...
          itemBuilder: (context, i) {
            return itemWidget(
                ...
                onTap: () async {
                  setIntAsync(DETAIL_PAGE_VARIANT, i);
                  i = i;
  ...
  Widget itemWidget({@required Function onTap, String title, int code = 0, String img}) {
    return Container(
      width: context.width(),
